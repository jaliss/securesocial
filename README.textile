...
h2. Running the Scala Demo
$ sbt
... lots of output ...
> project scalaDemo
[info] Set current project to scala-demo (in build file:/var/work/securesocial/)
> run

Navigate to http://localhost:9000

h2. Running the Java Demo
$ sbt
... lots of output ...
> project javaDemo
[info] Set current project to java-demo (in build file:/var/work/securesocial/)
> run
