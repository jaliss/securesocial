...
This fork of secure social can be included into your Play project like this:

<pre>"com.micronautics" %% "securesocial" % "2.1.1-SNAPSHOT" withSources()</pre>
...with this resolver (textile messes this up; look at the original file, not the rendered HTML for the actual instruction):
<pre>Resolver.url("play-plugin-snapshots", new URL("http://repo.scala-sbt.org/scalasbt/sbt-plugin-snapshots/"))(Resolver.ivyStylePatterns)</pre>
