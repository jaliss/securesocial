...
public class InMemoryUserService extends BaseUserService {
    ...
    public Identity doSave(Identity user) {
        users.put(user.userIdFromProvider().authId() + user.userIdFromProvider().providerId(), user);
    ...
    @Override
    public Identity doFind(UserIdFromProvider userIdFromProvider) {
        return users.get(userIdFromProvider.authId() + userIdFromProvider.providerId());
    }
    ...
    public Identity doFindByEmailAndProvider(String email, String providerId) {
        ...
        for( Identity user : users.values() ) {
            ...
            if ( user.userIdFromProvider().providerId().equals(providerId) &&
