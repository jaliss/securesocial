 ...
 */
case class SocialUser(identityId: IdentityId,firstName: String, lastName: String, fullName: String, nickName: Option[String], state: String, email: Option[String],
...
object SocialUser {
  def apply(i: Identity): SocialUser = {
    SocialUser(
      i.identityId, i.firstName, i.lastName, i.fullName, i.nickName, i.state,
