...
public enum AuthenticationMethod {
    ...
    public static AuthenticationMethod fromScala(final securesocial.core.AuthenticationMethod scalaMethod) {
    ...
    public static securesocial.core.AuthenticationMethod toSala(final AuthenticationMethod method) {
